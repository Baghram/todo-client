...
function onSignIn(googleUser) {
    ...
    emptyTable()
    $.ajax({
        url:'https://boiling-sea-17645.herokuapp.com/user/googlelogin',
        method:"POST",
        headers:{
...
$(document).ready(function() {
   ...
   LogoutButton()
    $("#form-Register").on('submit', function(e) {
        e.preventDefault()
        $.ajax({
            url:"https://boiling-sea-17645.herokuapp.com/user/register",
            method:"POST",
            data:{
                Email: $("#Email").val(),
    ...
    $("#form-Login").on('submit', function(e) {
        e.preventDefault()
        $.ajax({
            url:"https://boiling-sea-17645.herokuapp.com/user/login",
            method: "POST",
